...
const int numOfCards = 6;//the nuber of cards used. this can change as you want
byte cards[numOfCards][7] = {{0xA9, 0x98, 0x7C, 0x14},{0x12, 0xB7, 0xA5, 0x1E},{0x04 ,0x7B ,0x7D ,0x8A ,0x98 ,0x72 ,0x80},{0x04 ,0x62 ,0x77 ,0x0A ,0x3C ,0x78 ,0x80},{0x04 ,0x66 ,0x83 ,0x9A ,0x0D ,0x6D ,0x80},{0x04 ,0x40 ,0x80 ,0x3A ,0x29 ,0x44 ,0x80}}; // array of UIDs of rfid cards
...
String names[numOfCards] = {"Person 1","Person 2","Person 3","Person 4","Person 5","Person 6"};//student names
long sNumbers[numOfCards] = {001,002,003,004,005};//student sNumbers
